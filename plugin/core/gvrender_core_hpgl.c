...
static char *hpglcolor[] = {"black",   "blue",   "green", "cyan",      "red",
...
static void hpgl_resolve_color(GVJ_t *job, gvcolor_t *color) {
  ...
  switch (color->type) {
    case COLOR_STRING:
      ...
      break;
    case RGBA_BYTE:
      i = 32 + hpglColorResolve(&new, color->u.rgba[0], color->u.rgba[1],
                                color->u.rgba[2]);
      if (new)
...
static void hpgl_line_style(obj_state_t *obj, int *line_style,
                            double *style_val) {
  switch (obj->pen) {
    case PEN_DASHED:
      *line_style = 1;
...
static void hpgl_end_graph(GVJ_t *job) { gvputs(job, "# end of FIG file\n"); }

static void hpgl_begin_page(GVJ_t *job) { Depth = 2; }

static void hpgl_begin_node(GVJ_t *job) { Depth = 1; }

static void hpgl_end_node(GVJ_t *job) { Depth = 2; }

static void hpgl_begin_edge(GVJ_t *job) { Depth = 0; }

static void hpgl_end_edge(GVJ_t *job) { Depth = 2; }
...
gvrender_engine_t hpgl_engine = {
    0,                                       /* hpgl_begin_job */
    0,                                       /* hpgl_end_job */
    hpgl_begin_graph, hpgl_end_graph,     0, /* hpgl_begin_layer */
    0,                                       /* hpgl_end_layer */
    hpgl_begin_page,  0,                     /* hpgl_end_page */
    ...
    0,                                       /* hpgl_begin_edges */
    0,                                       /* hpgl_end_edges */
    hpgl_begin_node,  hpgl_end_node,      hpgl_begin_edge,
    hpgl_end_edge,    0, /* hpgl_begin_anchor */
    0,                   /* hpgl_end_anchor */
    0,                   /* hpgl_begin_label */
    0,                   /* hpgl_end_label */
    hpgl_textpara,    hpgl_resolve_color, hpgl_ellipse,
    hpgl_polygon,     hpgl_bezier,        hpgl_polyline,
    hpgl_comment,     0, /* hpgl_library_shape */
};
