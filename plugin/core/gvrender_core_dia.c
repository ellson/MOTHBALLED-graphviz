...
static void dia_begin_job(GVJ_t *job) {
...
static void dia_end_graph(GVJ_t *job) { gvprintf(job, "</dia:diagram>\n"); }

static void dia_begin_page(GVJ_t *job) {
  gvprintf(job, "  <dia:layer name=\"Background\" visible=\"true\">\n");
}

static void dia_end_page(GVJ_t *job) { gvputs(job, "  </dia:layer>\n"); }
...
static void dia_end_cluster(GVJ_t *job) { gvprintf(job, "    </dia:group>\n"); }

static void dia_begin_node(GVJ_t *job) { gvprintf(job, "    <dia:group>\n"); }

static void dia_end_node(GVJ_t *job) { gvprintf(job, "    </dia:group>\n"); }

static void dia_begin_edge(GVJ_t *job) { gvprintf(job, "    <dia:group>\n"); }

static void dia_end_edge(GVJ_t *job) { gvprintf(job, "    </dia:group>\n"); }
...
static void dia_bezier(GVJ_t *job, pointf *A, int n, int arrow_at_start,
...
gvrender_engine_t dia_engine = {
    ...
    dia_comment,       0, /* dia_library_shape */
};
...
static gvdevice_features_t device_features_dia = {
    GVDEVICE_BINARY_FORMAT | GVDEVICE_COMPRESSED_FORMAT, /* flags */
