...
static gvplugin_api_t apis[] = {{API_device, gvdevice_dot_types},
...
__declspec(dllimport) gvplugin_library_t gvplugin_core_LTX_library = {"core",
                                                                      apis};
#else
__declspec(dllexport) gvplugin_library_t gvplugin_core_LTX_library = {"core",
                                                                      apis};
#endif
#endif
