...
static void fig_line_style(obj_state_t *obj, int *line_style,
                           double *style_val) {
  switch (obj->pen) {
    case PEN_DASHED:
      *line_style = 1;
...
static void fig_comment(GVJ_t *job, char *str) { gvprintf(job, "# %s\n", str); }
...
static void fig_end_graph(GVJ_t *job) { gvputs(job, "# end of FIG file\n"); }

static void fig_begin_page(GVJ_t *job) { Depth = 2; }

static void fig_begin_node(GVJ_t *job) { Depth = 1; }

static void fig_end_node(GVJ_t *job) { Depth = 2; }

static void fig_begin_edge(GVJ_t *job) { Depth = 0; }

static void fig_end_edge(GVJ_t *job) { Depth = 2; }
...
gvrender_engine_t fig_engine = {
    0,                                     /* fig_begin_job */
    0,                                     /* fig_end_job */
    fig_begin_graph, fig_end_graph,     0, /* fig_begin_layer */
    0,                                     /* fig_end_layer */
    ...
    0,                                     /* fig_begin_edges */
    0,                                     /* fig_end_edges */
    fig_begin_node,  fig_end_node,      fig_begin_edge,
    fig_end_edge,    0, /* fig_begin_anchor */
    0,                  /* fig_end_anchor */
    0,                  /* fig_begin_label */
    0,                  /* fig_end_label */
    fig_textspan,    fig_resolve_color, fig_ellipse,
    fig_polygon,     fig_bezier,        fig_polyline,
    fig_comment,     0, /* fig_library_shape */
};

/* NB.  List must be LANG_C sorted */
static char *fig_knowncolors[] = {"black",   "blue", "cyan",  "green",
                                  "magenta", "red",  "white", "yellow", };

gvrender_features_t render_features_fig = {
    EMIT_COLORS | GVRENDER_Y_GOES_DOWN,       /* flags */
