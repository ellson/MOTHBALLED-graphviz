...
#define RE_SYNTAX_POSIX_EXTENDED                                               \
  (_RE_SYNTAX_POSIX_COMMON | RE_CONTEXT_INDEP_ANCHORS | RE_CONTEXT_INDEP_OPS | \
...
int regexec _RE_ARGS((const regex_t *preg, const char *string, size_t nmatch,
                      regmatch_t pmatch[], int eflags));
size_t regerror _RE_ARGS((int errcode, const regex_t *preg, char *errbuf,
                          size_t errbuf_size));
