...
struct PriorityQueue_struct {
  /* a simple priority queue structure: entries are all integers, gains are all
   * integers in [0, gainmax], total n elements */
...
int PriorityQueue_pop(PriorityQueue q, int *i,
                      int *gain); /* return 0 if nmothing left, 1 otherwise */
