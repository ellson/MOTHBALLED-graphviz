...
main() {
  ...
  if ((long)dtdelete(dt, NIL(Void_t*)) != 3) terror("Dtstack pop 3.3");
  ...
  if ((long)dtdelete(dt, NIL(Void_t*)) != 2) terror("Dtstack pop 2.2");
  if ((long)dtdelete(dt, NIL(Void_t*)) != 2) terror("Dtstack pop 2.1");
  if ((long)dtdelete(dt, NIL(Void_t*)) != 3) terror("Dtstack pop 3.1");
  if ((long)dtdelete(dt, NIL(Void_t*)) != 1) terror("Dtstack pop 1");
