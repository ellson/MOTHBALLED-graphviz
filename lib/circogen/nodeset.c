...
static void freeItem(Dt_t *d, nsitem_t *obj, Dtdisc_t *disc) { free(obj); }
 ...
 */
void clearNodeset(nodeset_t *s) { dtclear(s); }
 ...
 */
int sizeNodeset(nodeset_t *ns) { return dtsize(ns); }
