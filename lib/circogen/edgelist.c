...
static void freeItem(Dt_t *d, edgelistitem *obj, Dtdisc_t *disc) { free(obj); }
...
static Dtdisc_t ELDisc = {offsetof(edgelistitem, edge), /* key */
...
int size_edgelist(edgelist *list) { return dtsize(list); }
