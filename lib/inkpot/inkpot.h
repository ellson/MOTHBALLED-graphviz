...
extern inkpot_status_t inkpot_write_disc(inkpot_t *inkpot,
                                         inkpot_write_disc_t disc);
extern inkpot_status_t inkpot_write_closure(inkpot_t *inkpot, void *closure);

extern inkpot_status_t inkpot_schemes_put(inkpot_t *inkpot,
                                          const char *schemes);
...
extern inkpot_status_t inkpot_put_rgba_i(inkpot_t *inkpot,
                                         unsigned short rgba[4]);
extern inkpot_status_t inkpot_put_hsva_i(inkpot_t *inkpot,
                                         unsigned short hsva[4]);
extern inkpot_status_t inkpot_put_cmyk_i(inkpot_t *inkpot,
...
extern inkpot_status_t inkpot_get_rgba_i(inkpot_t *inkpot,
                                         unsigned short rgba[4]);
extern inkpot_status_t inkpot_get_hsva_i(inkpot_t *inkpot,
                                         unsigned short hsva[4]);
extern inkpot_status_t inkpot_get_cmyk_i(inkpot_t *inkpot,
                                         unsigned short cmyk[4]);
