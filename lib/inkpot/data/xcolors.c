...
static XColorEntry xColors[] = {{"alice blue", 240, 248, 255},
...
Status XParseColor(Display *display, Colormap map, const char *spec,
  ...
  if (spec[0] == '#') {
    ...
    colorPtr->red =
        (((unsigned short)red) << (4 * (4 - i))) | ((unsigned short)red);
    colorPtr->green =
        (((unsigned short)green) << (4 * (4 - i))) | ((unsigned short)green);
    colorPtr->blue =
        (((unsigned short)blue) << (4 * (4 - i))) | ((unsigned short)blue);
  } else {
