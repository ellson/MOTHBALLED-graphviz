...
inkpot_status_t inkpot_value_set(inkpot_values_t *values,
...
inkpot_status_t inkpot_value_get(inkpot_values_t *values,
                                 inkpot_value_t *value) {
  IDX_VALUES_24_t i;
  unsigned short v;

  /* FIXME - this routine must check for 8 bit values and properly scale to 16
   * for the api */
...
inkpot_status_t inkpot_value_get_first(inkpot_values_t *values,
                                       inkpot_value_t *value) {
  value->index = 0;
  return inkpot_value_get(values, value);
}

inkpot_status_t inkpot_value_get_next(inkpot_values_t *values,
                                      inkpot_value_t *value) {
  value->index++;
  return inkpot_value_get(values, value);
}
