...
typedef Void_t *(*Vmemory_f)_ARG_((Vmalloc_t *, Void_t *, size_t, size_t,
                                   Vmdisc_t *));
...
extern int vmwalk
    _ARG_((Vmalloc_t *, int (*)(Vmalloc_t *, Void_t *, size_t, Vmdisc_t *)));
extern char *vmstrdup _ARG_((Vmalloc_t *, const char *));

#if !defined(_AST_STD_H) && !defined(__stdlib_h) && !defined(__STDLIB_H) && \
    !defined(_hdr_stdlib) && !defined(_STDLIB_INCLUDED) &&                  \
    !defined(_INC_STDLIB)
...
#define vmalloc(vm, sz) (_VMFL_(vm), (*(_VM_(vm)->meth.allocf))((vm), (sz)))
#define vmresize(vm, d, sz, type) \
  (_VMFL_(vm), (*(_VM_(vm)->meth.resizef))((vm), (Void_t *)(d), (sz), (type)))
#define vmfree(vm, d) \
  (_VMFL_(vm), (*(_VM_(vm)->meth.freef))((vm), (Void_t *)(d)))
#define vmalign(vm, sz, align) \
  (_VMFL_(vm), (*(_VM_(vm)->meth.alignf))((vm), (sz), (align)))
...
#define malloc(s) (_VMFL_(Vmregion), _VMNM_(mallo, /, *, *, /, c)((size_t)(s)))
#define realloc(d, s) \
  (_VMFL_(Vmregion), _VMNM_(reallo, /, *, *, /, c)((Void_t *)(d), (size_t)(s)))
#define calloc(n, s) \
  (_VMFL_(Vmregion), _VMNM_(callo, /, *, *, /, c)((size_t)n, (size_t)(s)))
#define free(d) (_VMFL_(Vmregion), _VMNM_(fre, /, *, *, /, e)((Void_t *)(d)))
#define memalign(a, s) \
  (_VMFL_(Vmregion), _VMNM_(memalig, /, *, *, /, n)((size_t)(a), (size_t)(s)))
...
#ifndef vmresize
#define vmresize(vm, d, sz, type) \
  (*(_VM_(vm)->meth.resizef))((vm), (Void_t *)(d), (sz), (type))
#endif
#ifndef vmfree
