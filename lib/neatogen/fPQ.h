...
#ifdef PQ_CODE
static void PQgen(PQ* pq, int sz, PQTYPE guard) {
...
static void PQinit(PQ* pq) { pq->PQcnt = 0; }

#ifdef PQCHECK
static int PQcheck(PQ* pq) {
  int i;
...
static int PQinsert(PQ* pq, PQTYPE np) {
...
static void PQupdate(PQ* pq, PQTYPE n, PQVTYPE d) {
  N_VAL(pq, n) = d;
