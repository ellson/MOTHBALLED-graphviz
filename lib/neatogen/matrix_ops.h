...
extern void right_mult_with_vector(vtx_data *, int, double *, double *);
extern void right_mult_with_vector_f(float **, int, double *, double *);
...
extern double vectors_inner_product(int n, double *vector1, double *vector2);
...
#ifdef UNUSED
extern void mat_mult_vec(vtx_data *L, int n, double *vec, double *result);
#endif
extern void right_mult_with_vector_transpose(double **, int, int, double *,
                                             double *);
extern void right_mult_with_vector_d(double **, int, int, double *, double *);
extern void mult_dense_mat(double **, float **, int, int, int, float ***C);
extern void mult_dense_mat_d(double **, float **, int, int, int, double ***CC);
extern void mult_sparse_dense_mat_transpose(vtx_data *, double **, int, int,
                                            float ***);
...
extern void right_mult_with_vector_fd(float **, int, float *, double *);
#endif
...
extern double vectors_inner_productf(int n, float *vector1, float *vector2);
...
extern void mat_mult_vecf(vtx_data *L, int n, float *vec, float *result);
#endif
