...
extern int compute_hierarchy(vtx_data*, int, double, double, double*, int**,
                             int**, int*);
...
extern int stress_majorization_cola(vtx_data*, int, int, double**, node_t**,
                                    int, int, int, ipsep_options*);
#endif
#endif
#endif
